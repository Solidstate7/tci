export const T = {
    ...
    de: {
        title: "Temperament & Charakter", subtitle: "Cloningers TCI-Bewertung", qOf: (c, t) => `Frage ${c} von ${t}`, complete: (p) => `${p}% abgeschlossen`, back: "← Zurück", skip: "Überspringen →", results: "Ergebnisse ansehen →", retake: "Test wiederholen", yourProfile: "Ihr TCI-Profil", profileSub: "Temperament & Charakter", temperament: "Temperament", tempDesc: "Vererbbare Tendenzen in automatischen emotionalen Reaktionen", character: "Charakter", charDesc: "Entwickelt durch Einsicht und Lernen im Laufe des Lebens", note: "Hinweis:", noteText: "Dies ist eine informelle Selbsteinschätzung, die zu Bildungszwecken vom TCI-Modell Cloningers inspiriert wurde. Es handelt sich nicht um ein validiertes klinisches Instrument.", balanced: "Ausgewogen zwischen den Extremen", sd: "Stimme gar nicht zu", d: "Stimme nicht zu", n: "Neutral", a: "Stimme zu", sa: "Stimme völlig zu",
    }
};
...
export const INTERP = {
    ...
    HA: {
        ...
        de: {
            low: "Optimistisch, mutig, selbstbewusst, kontaktfreudig, energisch",
            high: "Vorsichtig, angespannt, ängstlich, gehemmt, leicht ermüdbar",
            detail: {
                low: "Klinisch impliziert eine geringe Schadensvermeidung eine verringerte Empfindlichkeit des serotonergen Bestrafungssystems im Gehirn. Diese Individuen zeigen ausgeprägten Mut, beständigen Optimismus und einen starken Mangel an Erwartungsangst.",
                high: "Eine hohe Schadensvermeidung ist durch ein überaktives Verhaltenshemmungssystem gekennzeichnet, das eng an die serotonerge Funktion gebunden ist. Sie sind stark anfällig für Erwartungsangst und übermäßige Sorgen.",
                balanced: "Ein ausgewogener Wert für Schadensvermeidung spiegelt ein gut reguliertes serotonerges System wider. Das Individuum verfügt über eine angemessene Angstkonditionierung ohne lähmende Angst."
            }
        }
    },
    RD: {
        ...
        de: {
            low: "Unabhängig, losgelöst, kühl, praktisch, in sich ruhend",
            high: "Sentimental, warmherzig, verbunden, abhängig, offen",
            detail: {
                low: "Eine geringe Belohnungsabhängigkeit spiegelt ein klinisches Profil von ausgeprägter emotionaler Distanziertheit und Autonomie von sozialer Verstärkung wider.",
                high: "Klinisch deutet eine hohe Belohnungsabhängigkeit auf eine Überempfindlichkeit gegenüber sozialen Reizen und emotionaler Verstärkung hin. Sie sind extrem empathisch, riskieren aber soziale Abhängigkeit.",
                balanced: "Ein ausgewogener Wert weist auf ein Individuum hin, das tiefe emotionale Verbindungen schätzt, aber eine gesunde funktionelle Autonomie beibehält."
            }
        }
    },
    PS: {
        ...
        de: {
            ...
            high: "Entschlossen, ehrgeizig, überdurchschnittlich leistungsbereit, ausdauernd",
            detail: {
                low: "Ein klinisch niedriger Beharrlichkeitswert weist auf eine sehr anpassungsfähige Frustrationstoleranz hin. Sie geben Widerständen schnell nach, um Ressourcen zu schonen.",
                high: "Hohe Beharrlichkeit zeugt von starker Widerstandsfähigkeit bei ausbleibender Belohnung. Pathologisch manifestiert sich dies in Perfektionismus, Workaholismus und Erschöpfung.",
                balanced: "Ein optimal ausgewogener Beharrlichkeitswert zeigt die Fähigkeit, zielgerichtetes Verhalten aufrechtzuerhalten, gekoppelt mit der Anpassungsfähigkeit, um sinnlose Projekte flexibel abwickeln zu können."
            }
        }
    },
    SD: {
        ...
        de: {
            low: "Vorwurfsvoll, orientierungslos, fragil, unzuverlässig",
            high: "Zielstrebig, verantwortlich, erfinderisch, selbstakzeptierend",
            detail: {
                low: "Eine geringe Selbstlenkung ist ein klinischer Kernmarker für emotionale Fragilität. Diese Personen suchen häufig Fehler bei anderen und fühlen sich als Opfer der Umstände.",
                high: "Eine hohe Selbstlenkung ist ein Hauptindikator für robuste psychologische Reife. Klinisch spiegelt dies einen starken internen Kontrollort wider.",
                balanced: "Ein ausgewogener Wert deutet auf allgemein angemessene Bewältigungsmechanismen und ein funktionales Ich hin."
            }
        }
    },
    CO: {
        ...
        de: {
            ...
            detail: {
                low: "Klinisch ist eine signifikant niedrige Kooperationsbereitschaft oft mit antagonistischen oder antisozialen Persönlichkeitsmerkmalen verbunden.",
                high: "Eine hohe Kooperationsbereitschaft bedeutet reife soziale Integration und tiefgreifende prosoziale emotionale Schemata.",
                balanced: "Ein ausgewogener Wert zeigt ein gesundes psychosoziales Gleichgewicht mit echtem Mitgefühl bei gleichzeitiger Wahrung der persönlichen Grenzen."
            }
        }
    },
    ST: {
        ...
        de: {
            ...
            detail: {
                low: "Eine klinisch niedrige Selbsttranszendenz weist auf einen hyperrationalen und ausgeprägt materialistischen kognitiven Rahmen hin.",
                high: "Eine hohe Selbsttranszendenz ist grundlegend mit einer tiefen spirituellen Ausrichtung und existenziellen Zufriedenheit verbunden.",
                balanced: "Ein ausgewogener Wert repräsentiert eine optimale existentielle Integration und kombiniert logische Weltbilder mit psychologischer Tiefe."
            }
        }
    },
};
